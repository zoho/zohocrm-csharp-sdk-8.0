...
namespace Com.Zoho.Crm.API.Webforms
{
	...
	public class WebForm : Model
	{
		...
		public AcknowledgeVisitor AcknowledgeVisitor
		{
			/// <summary>The method to get the acknowledgeVisitor</summary>
			/// <returns>Instance of AcknowledgeVisitor</returns>
			get
			{
			...
			/// <param name="acknowledgeVisitor">Instance of AcknowledgeVisitor</param>
			set
			{
		...
		public string ActionOnDuplicate
		{
			/// <summary>The method to get the actionOnDuplicate</summary>
			/// <returns>string representing the actionOnDuplicate</returns>
			get
			{
				return  this.actionOnDuplicate;

			}
			/// <summary>The method to set the value to actionOnDuplicate</summary>
			/// <param name="actionOnDuplicate">string</param>
			set
			{
		...
		public DoubleOptinDetails DoubleOptinDetails
		{
			/// <summary>The method to get the doubleOptinDetails</summary>
			/// <returns>Instance of DoubleOptinDetails</returns>
			get
			{
				return  this.doubleOptinDetails;

			}
			/// <summary>The method to set the value to doubleOptinDetails</summary>
			/// <param name="doubleOptinDetails">Instance of DoubleOptinDetails</param>
			set
			{
				 this.doubleOptinDetails=value;
		...
		{
			/// <summary>The method to get the formSections</summary>
			/// <returns>Instance of List<FormSection></returns>
			get
			{
				return  this.formSections;

			}
			/// <summary>The method to set the value to formSections</summary>
			/// <param name="formSections">Instance of List<FormSection></param>
			set
			{
		...
		public VisitorTracking VisitorTracking
		{
			/// <summary>The method to get the visitorTracking</summary>
			/// <returns>Instance of VisitorTracking</returns>
			get
			{
			...
			/// <param name="visitorTracking">Instance of VisitorTracking</param>
			set
			{
		...
		{
			/// <summary>The method to get the showBrand</summary>
			/// <returns>bool? representing the showBrand</returns>
			get
			{
				return  this.showBrand;

			}
			/// <summary>The method to set the value to showBrand</summary>
			/// <param name="showBrand">bool?</param>
			set
			{
		...
		public SpamControl SpamControl
		{
			/// <summary>The method to get the spamControl</summary>
			/// <returns>Instance of SpamControl</returns>
			get
			{
			...
			/// <param name="spamControl">Instance of SpamControl</param>
			set
			{
		...
		{
			/// <summary>The method to get the smartUrl</summary>
			/// <returns>string representing the smartUrl</returns>
			get
			{
				return  this.smartUrl;

			}
			/// <summary>The method to set the value to smartUrl</summary>
			/// <param name="smartUrl">string</param>
			set
			{
				 this.smartUrl=value;
