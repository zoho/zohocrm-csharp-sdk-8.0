...
namespace Com.Zoho.Crm.API.Webforms
{
	...
	public class FormAttributes : Model
	{
		...
		public Logo Logo
		{
			...
			/// <returns>Instance of Logo</returns>
			get
			{
				return  this.logo;
			...
			/// <param name="logo">Instance of Logo</param>
			set
			{
				 this.logo=value;
		...
		public Background Background
		{
			...
			/// <returns>Instance of Background</returns>
			get
			{
			...
			/// <param name="background">Instance of Background</param>
			set
			{
		...
		public bool? DisplayFormName
		{
			/// <summary>The method to get the displayFormName</summary>
			/// <returns>bool? representing the displayFormName</returns>
			get
			{
			...
			/// <param name="displayFormName">bool?</param>
			set
			{
