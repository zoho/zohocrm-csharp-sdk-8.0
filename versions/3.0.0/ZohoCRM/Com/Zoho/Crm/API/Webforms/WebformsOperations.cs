...
namespace Com.Zoho.Crm.API.Webforms
{
	...
	public class WebformsOperations
	{
		...
		public APIResponse<ResponseHandler> GetWebForms()
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v8/settings/webforms");
		...
		/// <param name="formId">string</param>
		/// <returns>Instance of APIResponse<ResponseHandler></returns>
		public APIResponse<ResponseHandler> GetWebForm(string formId)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="request">Instance of BodyWrapper</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> UpdateWebForm(string formId, BodyWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="formId">string</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> DeleteWebForms(string formId)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="formId">string</param>
		/// <returns>Instance of APIResponse<ResponseHandler></returns>
		public APIResponse<ResponseHandler> GetWebformsPreview(string formId)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
