...
namespace Com.Zoho.Crm.API.Modules
{
	...
	public class ModuleFields : Fields.Fields , Model
	{
		...
		private List<Fields.FileUploadOption> fileUploadOptionlist;
		...
		private GlobalPicklists.Picklist globalPicklist;
		...
		public List<Fields.FileUploadOption> FileUploadOptionlist
		{
			/// <summary>The method to get the fileUploadOptionlist</summary>
			/// <returns>Instance of List<FileUploadOption></returns>
			get
			{
				return  this.fileUploadOptionlist;

			}
			/// <summary>The method to set the value to fileUploadOptionlist</summary>
			/// <param name="fileUploadOptionlist">Instance of List<FileUploadOption></param>
			set
			{
				 this.fileUploadOptionlist=value;
		...
		public List<Fields.LayoutAssociation> LayoutAssociations
		{
		...
		public Fields.AutoNumber AutoNumber65
		{
			/// <summary>The method to get the autoNumber65</summary>
			/// <returns>Instance of AutoNumber</returns>
			get
			{
			...
			/// <summary>The method to set the value to autoNumber65</summary>
			/// <param name="autoNumber65">Instance of AutoNumber</param>
			set
			{
				 this.autoNumber65=value;
		...
		public GlobalPicklists.Picklist GlobalPicklist
		{
			...
			/// <param name="globalPicklist">Instance of Picklist</param>
			set
			{
