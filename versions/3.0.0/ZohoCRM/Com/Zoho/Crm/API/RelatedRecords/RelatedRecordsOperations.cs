...
namespace Com.Zoho.Crm.API.RelatedRecords
{
	...
	public class RelatedRecordsOperations
	{
		...
		public static class GetRelatedRecordsParam
		{
			...
			public static readonly Param<string> IDS=new Param<string>("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsParam");
		}
		...
		public static class GetRelatedRecordsUsingExternalIDParam
		{
			...
			public static readonly Param<string> IDS=new Param<string>("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsUsingExternalIDParam");
		}
