    ...
    public class UpdateNotification
    {
        public static void UpdateNotification_1()
        {
            try
            {
                ...
                notification.NotifyUrl = "https://www.example.com/updated-single-notification";

                notifications.Add(notification);
                bodyWrapper.Watch = notifications;

                APIResponse<ActionHandler> response = notificationsOperations.UpdateNotification(bodyWrapper);
