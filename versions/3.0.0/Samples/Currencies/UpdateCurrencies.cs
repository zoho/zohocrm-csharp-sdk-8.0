...
namespace Samples.Currencies
{
    public class UpdateCurrencies
    {
        public static void UpdateCurrencies_1()
        {
            ...
            currency1.Id = 3477061000004381001L;
            currency1.ExchangeRate = "0.88"; // Updated exchange rate
            ...
            currency2.Id = 3477061000004381002L;
            currency2.ExchangeRate = "0.77"; // Updated exchange rate
            currency2.IsActive = false; // Deactivating this currency
