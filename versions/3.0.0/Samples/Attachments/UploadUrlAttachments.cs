...
{
    public class UploadUrlAttachments
    {
        public static void UploadUrlAttachments_1(string moduleAPIName, long recordId, string attachmentUrl)
        {
            ...
            APIResponse<ActionHandler> response = attachmentOperations.UploadUrlAttachments(recordId, moduleAPIName, paramInstance);
            if (response != null)
            {
        ...
        public static void Call()
        {
            try
            {
                ...
                string attachmentUrl = "https://example.com/sample-file.pdf";
                UploadUrlAttachments_1(moduleAPIName, recordId, attachmentUrl);
            }
            catch (Exception e)
            {
