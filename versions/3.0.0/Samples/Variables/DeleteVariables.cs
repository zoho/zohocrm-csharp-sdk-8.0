...
namespace Samples.Variables_1
{
    ...
    {
        public static void DeleteVariables_1()
        {
            try
            {
                ...
                // Add variable IDs to delete (comma-separated)
                parameterMap.Add(VariablesOperations.DeleteVariablesParam.IDS, "1055806000028633004,554023000000567024");

                // Call API
                APIResponse<ActionHandler> response = variablesOperations.DeleteVariables(parameterMap);
                ...
                if (response != null)
                {
                    ...
                    if (response.IsExpected)
                    {
                        ...
                        if (actionHandler is ActionWrapper)
                        {
                            ...
                            Console.WriteLine($"Processed {actionResponses?.Count ?? 0} variable deletions:");
