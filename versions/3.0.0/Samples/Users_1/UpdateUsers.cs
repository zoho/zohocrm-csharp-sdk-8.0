    ...
    public class UpdateUsers
    {
        public static void UpdateUsers_1()
        {
            try
            {
                ...
                user1.Id = 1055806000028632001L; // Replace with actual user ID
                user1.FirstName = "John Updated";
                user1.LastName = "Doe Updated";
                user1.Email = "john.doe.updated@example.com";

                Role role1 = new Role();
                role1.Id = 554023000000567024L; // Replace with actual role ID
                user1.Role = role1;
                ...
                if (response != null)
                {
                    ...
                    if (response.IsExpected)
                    {
                        ...
                        if (actionHandler is ActionWrapper)
                        {
                            ...
                            Console.WriteLine($"Processed {actionResponses?.Count ?? 0} user updates:");
