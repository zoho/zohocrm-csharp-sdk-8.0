...
namespace Com.Zoho.Crm.API.Record
{
	...
	public class RecordOperations
	{
		...
		/// <summary>The method to get rich text records</summary>
		/// <param name="paramInstance">Instance of ParameterMap</param>
		/// <returns>Instance of APIResponse<ResponseHandler></returns>
		public APIResponse<ResponseHandler> GetRichTextRecords(ParameterMap paramInstance)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		/// <param name="id">long?</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> CloneRecord(long? id)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();
		...
		{
			public static readonly Param<string> IDS=new Param<string>("ids", "com.zoho.crm.api.Record.GetRichTextRecordsParam");
			public static readonly Param<string> FIELDS=new Param<string>("fields", "com.zoho.crm.api.Record.GetRichTextRecordsParam");
		}
