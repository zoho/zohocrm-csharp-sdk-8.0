...
namespace csharpsdksampleapplication.Samples.Record
{
    public class GetRichTextRecords
    {
        public static void GetRichTextRecords_1(String moduleAPIName)
        {
            RecordOperations recordOperations = new RecordOperations(moduleAPIName);
            ParameterMap paramInstance = new ParameterMap();
            paramInstance.Add(GetRichTextRecordsParam.IDS, "3477002");
            APIResponse<ResponseHandler> response = recordOperations.GetRichTextRecords(paramInstance);
            if (response != null)
            {
        ...
        public static void Call()
        {
            try
            {
                ...
                GetRichTextRecords_1(moduleAPIName);
            }
            catch (Exception e)
            {
