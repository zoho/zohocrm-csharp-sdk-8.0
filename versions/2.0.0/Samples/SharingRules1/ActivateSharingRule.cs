...
{
    public class ActivateSharingRule
    {
        public static void ActivateSharingRule_1(long id, String moduleAPIName)
        {
            SharingRulesOperations sharingRulesOperations = new SharingRulesOperations(moduleAPIName);
            APIResponse<ActionHandler> response = sharingRulesOperations.ActivateSharingRule(id);
            if (response != null)
            {
        ...
        public static void Call()
        {
            try
            {
                ...
                long id = 347701001;
                ActivateSharingRule_1(id, moduleAPIName);
            }
            catch (Exception e)
            {
