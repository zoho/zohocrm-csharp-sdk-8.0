...
namespace Samples.CadencesExecution
{
	...
	{
		public static void EnrollCadences_1(string ModuleAPIName)
		{
			...
			cadencesIds.Add("3477063785001");
			request.CadencesIds = cadencesIds;
			List<string> ids = new List<string>();
			ids.Add("34770614115001");
			request.Ids = ids;
			APIResponse<ActionHandler> response = cadencesExecutionOperations.EnrollCadences(ModuleAPIName, request);
			if (response != null)
			{
		...
		public static void Call()
		{
			try
			{
                ...
                EnrollCadences_1(ModuleAPIName);
			}
			catch (Exception e)
			{
