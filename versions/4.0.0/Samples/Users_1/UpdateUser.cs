...
namespace Samples.Users_1
{
    ...
    {
        public static void UpdateUser_1()
        {
            try
            {
                ...
                user.Language = "en_US";
                user.Locale = "en_US";
                user.CountryLocale = "US";
                user.Signature = "Best regards, John Doe";

                // Update role
                Role role = new Role();
                role.Id = 554023000000567024L; // Replace with actual role ID
                user.Role = role;

                // Update profile
                Com.Zoho.Crm.API.Users.Profile profile = new Com.Zoho.Crm.API.Users.Profile();
                profile.Id = 554023000000567025L; // Replace with actual profile ID
                user.Profile = profile;

                // Set reporting manager
                MinifiedUser reportingTo = new MinifiedUser();
                reportingTo.Id = 554023000000567026L; // Replace with actual manager ID
