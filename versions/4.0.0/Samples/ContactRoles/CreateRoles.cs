...
namespace Samples.ContactRoles
{
    public class CreateRoles
    {
        public static void CreateRoles_1()
        {
            ...
            contactRole1.Name = "Decision Maker";
            contactRole1.SequenceNumber = 1;
            contactRoles.Add(contactRole1);

            ContactRole contactRole2 = new ContactRole();
            contactRole2.Name = "Influencer";
            contactRole2.SequenceNumber = 2;
            contactRoles.Add(contactRole2);

            ContactRole contactRole3 = new ContactRole();
            contactRole3.Name = "Technical Contact";
            contactRole3.SequenceNumber = 3;
            contactRoles.Add(contactRole3);
