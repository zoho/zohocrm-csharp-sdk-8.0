...
namespace Samples.ContactRoles
{
    public class UpdateContactRole
    {
        public static void UpdateContactRole_1(long contactRoleId)
        {
            ...
            List<ContactRole> contactRoleList = new List<ContactRole>();
            ContactRole contactRole = new ContactRole();

            contactRole.Name = "Updated Contact Role";
            contactRole.SequenceNumber = 2;
            contactRoleList.Add(contactRole);

            bodyWrapper.ContactRoles = contactRoleList;
