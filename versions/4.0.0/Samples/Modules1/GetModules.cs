...
using GetModulesParam = Com.Zoho.Crm.API.Modules.ModulesOperations.GetModulesParam;
    ...
    public class GetModules
    {
        public static void GetModules_1()
        {
            try
            {
                ...
                paramInstance.Add(GetModulesParam.STATUS, "visible");
                HeaderMap headerInstance = new HeaderMap();
                APIResponse<ResponseHandler> response = modulesOperations.GetModules(paramInstance, headerInstance);
