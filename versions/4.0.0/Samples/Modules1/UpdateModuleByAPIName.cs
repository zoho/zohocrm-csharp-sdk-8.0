...
namespace Samples.Modules1
{
    ...
    {
        public static void UpdateModuleByAPIName_1()
        {
            try
            {
                string apiName = "CustomModule123";
                ModulesOperations modulesOperations = new ModulesOperations();
                BodyWrapper bodyWrapper = new BodyWrapper();
                List<Modules> modulesList = new List<Modules>();

                Modules module = new Modules();
                module.ModuleName = "Updated Custom Module";
                module.SingularLabel = "Updated Custom Record";
                module.PluralLabel = "Updated Custom Records";
                module.Description = "This module has been updated via API";

                modulesList.Add(module);
                bodyWrapper.Modules = modulesList;

                APIResponse<ActionHandler> response = modulesOperations.UpdateModuleByAPIName(apiName, bodyWrapper);
