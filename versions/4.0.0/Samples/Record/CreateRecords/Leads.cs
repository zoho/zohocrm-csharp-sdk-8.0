...
namespace Samples.Record.CreateRecords
{
	public class Leads
	{
		public static void CreateLeads_1(string moduleAPIName)
		{
			RecordOperations recordOperations = new RecordOperations("Appointments__s");
            ...
            record.Id = 347706118067004L;
            Dictionary<string, string> module = new Dictionary<string, string>();
            module.Add("id", "34770612179");
            module.Add("api_name", "Contacts");
            record.AddKeyValue("module", module);
            record1.AddKeyValue("Appointment_For", record);
	...
	//		headerInstance.Add (CreateRecordsHeader.X_EXTERNAL, "Quotes.Quoted_Items.Product_Name.Products_External");
			APIResponse<ActionHandler> response = recordOperations.UpdateRecord(347706120415007, bodyWrapper, headerInstance);
			if (response != null)
			{
