...
namespace Samples.RelatedRecords
{
    ...
    {
        public static void GetRelatedRecord_1(string moduleAPIName, long recordId, string relatedListAPIName, long relatedRecordId)
        {
            try
            {
                ...
                paramInstance.Add(GetRelatedRecordParam.FIELDS, "Last_Name,First_Name,Email,Phone,Created_Time,Modified_Time");
                HeaderMap headerInstance = new HeaderMap();
                APIResponse<ResponseHandler> response = relatedRecordsOperations.GetRelatedRecord(relatedRecordId, recordId, paramInstance, headerInstance);
        ...
        public static void Call()
        {
            try
            {
                ...
                GetRelatedRecord_1(moduleAPIName, recordId, relatedListAPIName, relatedRecordId);
            }
            catch (Exception e)
            {
                Console.WriteLine(JsonConvert.SerializeObject(e));
