    ...
    public class GetRelatedRecordsUsingExternalId
    {
        public static void GetRelatedRecordsUsingExternalId_1(string moduleAPIName, string externalValue, string relatedListAPIName)
        {
            try
            {
                ...
                paramInstance.Add(GetRelatedRecordsUsingExternalIDParam.PER_PAGE, 10);
                paramInstance.Add(GetRelatedRecordsUsingExternalIDParam.FIELDS, "Last_Name,First_Name,Email,Phone");

                HeaderMap headerInstance = new HeaderMap();
                headerInstance.Add(GetRelatedRecordsUsingExternalIDHeader.X_EXTERNAL, "Leads.External");
