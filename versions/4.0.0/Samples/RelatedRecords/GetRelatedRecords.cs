    ...
    public class GetRelatedRecords
    {
        public static void GetRelatedRecords_1(string moduleAPIName, long recordId, string relatedListAPIName)
        {
            try
            {
                ...
                paramInstance.Add(RelatedRecordsOperations.GetRelatedRecordsParam.PAGE, 1);
                paramInstance.Add(RelatedRecordsOperations.GetRelatedRecordsParam.PER_PAGE, 10);
                paramInstance.Add(RelatedRecordsOperations.GetRelatedRecordsParam.FIELDS, "Last_Name,First_Name,Email");
                //paramInstance.Add(RelatedRecordsOperations.GetRelatedRecordsParam.IDS, "1055806000001393066,1055806000000308001");
