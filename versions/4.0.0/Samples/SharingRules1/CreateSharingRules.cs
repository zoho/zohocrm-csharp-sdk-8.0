...
namespace csharpsdksampleapplication.Samples.SharingRules1
{
    ...
    {
        public static void CreateSharingRules_1(String moduleAPIName)
        {
            ...
            APIResponse<ActionHandler> response = sharingRulesOperations.CreateSharingRules(request);
            if (response != null)
            {
        ...
        public static void Call()
        {
            try
            {
                ...
                CreateSharingRules_1(moduleAPIName);
            }
            catch (Exception e)
            {
