...
{
    public class DeleteSharingRule
    {
        public static void DeleteSharingRule_1(long id, String moduleAPIName)
        {
            SharingRulesOperations sharingRulesOperations = new SharingRulesOperations(moduleAPIName);
            APIResponse<ActionHandler> response = sharingRulesOperations.DeleteSharingRule(id);
            if (response != null)
            {
        ...
        public static void Call()
        {
            try
            {
                ...
                long id = 347701001;
                DeleteSharingRule_1(id, moduleAPIName);
            }
            catch (Exception e)
            {
