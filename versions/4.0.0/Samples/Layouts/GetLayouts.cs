...
namespace Samples.Layouts
{
    public class GetLayouts
    {
        ...
        private static void PrintField(Com.Zoho.Crm.API.Fields.Fields field)
        {
            ...
            {
                LinkingDetails linkingDetails = multiSelectLookup.LinkingDetails;
                LinkingModule module = linkingDetails.Module;
                Console.WriteLine("Field Multiselectlookup LinkingDetails Module Visibility: " + module.Visibility);
                Console.WriteLine("Field Multiselectlookup LinkingDetails Module PluralLabel: " + module.PluralLabel);
                Console.WriteLine("Field Multiselectlookup LinkingDetails Module APIName: " + module.APIName);
                Console.WriteLine("Field Multiselectlookup LinkingDetails Module Id: " + module.Id);

                LookupField lookupfield = linkingDetails.LookupField;
                Console.WriteLine("Field MultiSelectLookup LinkingDetails LookupField APIName: " + lookupfield.APIName);
                Console.WriteLine("Field MultiSelectLookup LinkingDetails LookupField FieldLabel: " + lookupfield.FieldLabel);
                Console.WriteLine("Field MultiSelectLookup LinkingDetails LookupField Id: " + lookupfield.Id);

                LookupField connectedLookupField = linkingDetails.ConnectedLookupField;
                Console.WriteLine("Field MultiSelectLookup LinkingDetails ConnectedLookupField APIName: " + connectedLookupField.APIName);
                Console.WriteLine("Field MultiSelectLookup LinkingDetails ConnectedLookupField FieldLabel: " + connectedLookupField.FieldLabel);
                Console.WriteLine("Field MultiSelectLookup LinkingDetails ConnectedLookupField Id: " + connectedLookupField.Id);

                ConnectedDetails connectedDetails = multiSelectLookup.ConnectedDetails;
                LookupField lookupField = connectedDetails.Field;
                Console.WriteLine("Field Multiselectlookup ConnectedDetails Field APIName: " + lookupField.APIName);
                Console.WriteLine("Field Multiselectlookup ConnectedDetails Field FieldLabel: " + lookupField.FieldLabel);
                Console.WriteLine("Field Multiselectlookup ConnectedDetails Field id: " + lookupField.Id);

                LinkingModule connectedModule = connectedDetails.Module;
                Console.WriteLine("Field MultiSelectLookup ConnectedDetails Module PluralLabel: " + connectedModule.PluralLabel);
                Console.WriteLine("Field MultiSelectLookup ConnectedDetails Module APIName: " + connectedModule.APIName);
                Console.WriteLine("Field MultiSelectLookup ConnectedDetails Module Id: " + connectedModule.Id);

                List<LookupLayout> layouts = connectedDetails.Layouts;
                if (layouts != null)
                {
                    foreach (LookupLayout layout in layouts)
                    {
                        Console.WriteLine("Field MultiSelectLookup ConnectedDetails Layouts APIName: " + layout.APIName);
                        Console.WriteLine("Field MultiSelectLookup ConnectedDetails Layouts Id: " + layout.Id);
                    }
                }

                LookupRelatedList relatedList = multiSelectLookup.RelatedList;
                if (relatedList != null)
                {
                    Console.WriteLine("Field MultiSelectLookup RelatedList DisplayLabel: " + relatedList.DisplayLabel);
                    Console.WriteLine("Field MultiSelectLookup RelatedList APIName: " + relatedList.APIName);
                    Console.WriteLine("Field MultiSelectLookup RelatedList Id: " + relatedList.Id);
                }
            }
            ...
            if (field.Multiuserlookup != null)
            {
                ...
                LinkingDetails linkingDetails = multiuserlookup.LinkingDetails;
                LinkingModule module = linkingDetails.Module;
                Console.WriteLine("Field Multiuserlookup LinkingDetails Module Visibility: " + module.Visibility);
                Console.WriteLine("Field Multiuserlookup LinkingDetails Module PluralLabel: " + module.PluralLabel);
                Console.WriteLine("Field Multiuserlookup LinkingDetails Module APIName: " + module.APIName);
                Console.WriteLine("Field Multiuserlookup LinkingDetails Module Id: " + module.Id);

                LookupField lookupfield = linkingDetails.LookupField;
                Console.WriteLine("Field Multiuserlookup LinkingDetails LookupField APIName: " + lookupfield.APIName);
                Console.WriteLine("Field Multiuserlookup LinkingDetails LookupField FieldLabel: " + lookupfield.FieldLabel);
                Console.WriteLine("Field Multiuserlookup LinkingDetails LookupField Id: " + lookupfield.Id);

                LookupField connectedLookupField = linkingDetails.ConnectedLookupField;
                Console.WriteLine("Field Multiuserlookup LinkingDetails ConnectedLookupField APIName: " + connectedLookupField.APIName);
                Console.WriteLine("Field Multiuserlookup LinkingDetails ConnectedLookupField FieldLabel: " + connectedLookupField.FieldLabel);
                Console.WriteLine("Field Multiuserlookup LinkingDetails ConnectedLookupField Id: " + connectedLookupField.Id);

                Console.WriteLine("Field Multiuserlookup RecordAccess: " + multiuserlookup.RecordAccess);
            }
            Picklist globalPicklist = field.GlobalPicklist;
            if (globalPicklist != null)
            {
                Console.WriteLine("Fields GlobalPicklist Id: " + globalPicklist.Id);
                Console.WriteLine("Fields GlobalPicklist APIName: " + globalPicklist.APIName);
            }
        }
        ...
        public static void PrintPickListValue(PickListValue pickListValue)
        {
            ...
            Picklist globalPicklist = pickListValue.GlobalPicklistValue;
            if (globalPicklist != null)
            {
                Console.WriteLine("Fields GlobalPicklistValue Id: " + globalPicklist.Id);
                Console.WriteLine("Fields GlobalPicklistValue APIName: " + globalPicklist.APIName);
            }
