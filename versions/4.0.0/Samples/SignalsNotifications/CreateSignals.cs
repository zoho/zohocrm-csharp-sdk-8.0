...
using Com.Zoho.Crm.API.SignalsNotifications;
using Com.Zoho.Crm.API.Util;
using System.Collections.Generic;
using System.Reflection;
using Newtonsoft.Json;

namespace Samples.SignalsNotifications
{
    public class CreateSignals
    {
        public static void CreateSignals_1()
        {
            ...
            signal.SignalNamespace = "mailchimp.open";
            signal.Subject = "Java SDK Test";
            signal.Id = 34770605001;
            signal.Module = "Leads";
            signal.Message = "This is SDK sample code";
            signals.Add(signal);
            bodyWrapper.Signals = signals;
            ...
            if (response != null)
            {
                ...
                if (response.IsExpected)
                {
                    ...
                    if (actionHandler is ActionWrapper)
                    {
                        ...
                        List<ActionResponse> actionResponses = actionWrapper.Signals;
