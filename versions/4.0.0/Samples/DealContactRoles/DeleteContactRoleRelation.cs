...
{
    public class DeleteContactRoleRelation
    {
        public static void DeleteContactRoleRelation_1(long contactId, long dealId)
        {
            DealContactRolesOperations dealContactRolesOperations = new DealContactRolesOperations();
            APIResponse<ActionHandler> response = dealContactRolesOperations.DeleteContactRoleRelation(contactId, dealId);
        ...
        public static void Call()
        {
            try
            {
                ...
                DeleteContactRoleRelation_1(contactId, dealId);
            }
            catch (Exception e)
            {
