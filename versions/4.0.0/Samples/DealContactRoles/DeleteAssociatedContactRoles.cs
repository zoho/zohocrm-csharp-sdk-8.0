...
{
    public class DeleteAssociatedContactRoles
    {
        public static void DeleteAssociatedContactRoles_1(long dealId)
        {
            DealContactRolesOperations dealContactRolesOperations = new DealContactRolesOperations();
            ParameterMap paramInstance = new ParameterMap();

            // Add contact IDs to be deleted from the deal
            paramInstance.Add(DealContactRolesOperations.DeleteAssociatedContactRolesParam.IDS, "1055806000028564009,3477061000004381002,3477061000004381003");

            APIResponse<ActionHandler> response = dealContactRolesOperations.DeleteAssociatedContactRoles(dealId, paramInstance);
        ...
        public static void Call()
        {
            try
            {
                ...
                DeleteAssociatedContactRoles_1(dealId);
            }
            catch (Exception e)
            {
