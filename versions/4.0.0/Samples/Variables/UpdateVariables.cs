    ...
    public class UpdateVariables
    {
        public static void UpdateVariables_1()
        {
            try
            {
                ...
                variable1.Id = 1055806000028634001L; // Replace with actual variable ID
                variable1.Name = "Updated Test Variable 1";
                variable1.Value = "Updated Test Value 1";
                variable1.Description = "This is an updated test variable";

                variablesList.Add(variable1);

                // Update second variable
                Variable variable2 = new Variable();
                variable2.Id = 554023000000567024L; // Replace with actual variable ID
                variable2.Name = "Updated Test Variable 2";
                variable2.Value = "67890";
                variable2.Description = "This is another updated test variable";
                ...
                if (response != null)
                {
                    ...
                    if (response.IsExpected)
                    {
                        ...
                        if (actionHandler is ActionWrapper)
                        {
                            ...
                            Console.WriteLine($"Processed {actionResponses?.Count ?? 0} variable updates:");
