...
namespace Samples.Variables_1
{
    ...
    {
        public static void UpdateVariableById_1()
        {
            try
            {
                ...
                variable.Description = "Updated variable description";
                ...
                // Add group parameter
                parameterMap.Add(VariablesOperations.UpdateVariableByIDParam.GROUP, "General");

                // Call API
                APIResponse<ActionHandler> response = variablesOperations.UpdateVariableById(variableId, request, parameterMap);
                        ...
                        if (actionHandler is ActionWrapper)
                        {
                            ...
                            if (actionResponses != null && actionResponses.Count > 0)
                            {
                                ...
                                if (actionResponse is SuccessResponse)
                                {
                                    ...
                                    Console.WriteLine("Variable ID " + variableId + " updated successfully");
                                    Console.WriteLine("---");
                                }
                                else if (actionResponse is APIException)
                                {
                                    ...
                                    Console.WriteLine("Failed to update variable ID: " + variableId);
                                    Console.WriteLine("---");
                                }
                            }
                            else
