    ...
    public class UpdateNotifications
    {
        public static void UpdateNotifications_1()
        {
            try
            {
                ...
                notification.ChannelExpiry = new DateTimeOffset(new DateTime(2026, 01, 15, 12, 0, 0, DateTimeKind.Utc));
                notification.Token = "UPDATED_TOKEN_FOR_VERIFICATION";
                notification.NotifyUrl = "https://www.example.com/updated-notifications";

                notifications.Add(notification);
                bodyWrapper.Watch = notifications;

                APIResponse<ActionHandler> response = notificationsOperations.UpdateNotifications(bodyWrapper);
