...
namespace Com.Zoho.Crm.API.Attachments
{
	...
	public class Attachment : Model
	{
		...
		private string attachmentSourceS;
		...
		public string RecordStatusS
		{
			/// <summary>The method to get the recordStatusS</summary>
			/// <returns>string representing the recordStatusS</returns>
			get
			{
				return  this.recordStatusS;

			}
			/// <summary>The method to set the value to recordStatusS</summary>
			/// <param name="recordStatusS">string</param>
			set
			{
				 this.recordStatusS=value;
		...
		public string AttachmentSourceS
		{
			/// <summary>The method to get the attachmentSourceS</summary>
			/// <returns>string representing the attachmentSourceS</returns>
			get
			{
				return  this.attachmentSourceS;

			}
			/// <summary>The method to set the value to attachmentSourceS</summary>
			/// <param name="attachmentSourceS">string</param>
			set
			{
				 this.attachmentSourceS=value;
		...
		public string FieldStates
		{
			...
			/// <returns>string representing the fieldStates</returns>
			get
			{
			...
			/// <param name="fieldStates">string</param>
			set
			{
		...
		public string ZiaVisions
		{
			/// <summary>The method to get the ziaVisions</summary>
			/// <returns>string representing the ziaVisions</returns>
			get
			{
			...
			/// <param name="ziaVisions">string</param>
			set
			{
