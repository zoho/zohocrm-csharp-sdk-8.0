...
namespace Com.Zoho.Crm.API.GlobalPicklists
{
	...
	public class Picklist : Model
	{
		...
		private int? associatedFieldsCount;
		private List<Module> usedInModules;
		...
		public int? AssociatedFieldsCount
		{
			/// <summary>The method to get the associatedFieldsCount</summary>
			/// <returns>int? representing the associatedFieldsCount</returns>
			get
			{
				return  this.associatedFieldsCount;

			}
			/// <summary>The method to set the value to associatedFieldsCount</summary>
			/// <param name="associatedFieldsCount">int?</param>
			set
			{
				 this.associatedFieldsCount=value;
		...
		public List<Module> UsedInModules
		{
			/// <summary>The method to get the usedInModules</summary>
			...
			/// <summary>The method to set the value to usedInModules</summary>
			/// <param name="usedInModules">Instance of List<Module></param>
			set
			{
				 this.usedInModules=value;
