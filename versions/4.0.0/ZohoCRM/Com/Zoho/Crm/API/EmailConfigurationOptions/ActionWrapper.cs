...
namespace Com.Zoho.Crm.API.EmailConfigurationOptions
{
	...
	{
		private List<ActionResponse> configurationOptions;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<ActionResponse> ConfigurationOptions
		{
			...
			/// <param name="configurationOptions">Instance of List<ActionResponse></param>
			set
			{
