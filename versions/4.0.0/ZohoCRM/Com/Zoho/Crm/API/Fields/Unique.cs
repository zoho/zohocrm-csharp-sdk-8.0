...
namespace Com.Zoho.Crm.API.Fields
{
	...
	public class Unique : Model
	{
		...
		{
			/// <summary>The method to get the disable</summary>
			/// <returns>object representing the disable</returns>
			get
			{
				return  this.disable;

			}
			/// <summary>The method to set the value to disable</summary>
			/// <param name="disable">object</param>
			set
			{
				 this.disable=value;
