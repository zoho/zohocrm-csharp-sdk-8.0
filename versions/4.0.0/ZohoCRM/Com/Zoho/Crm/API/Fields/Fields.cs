...
namespace Com.Zoho.Crm.API.Fields
{
	...
	public class Fields : Model
	{
		...
		private List<FileUploadOption> fileUploadOptionlist;
		...
		private AutoNumber autoNumber61;
		...
		public List<FileUploadOption> FileUploadOptionlist
		{
		...
		public AutoNumber AutoNumber61
		{
			/// <summary>The method to get the autoNumber61</summary>
			/// <returns>Instance of AutoNumber</returns>
			get
			{
			...
			/// <summary>The method to set the value to autoNumber61</summary>
			/// <param name="autoNumber61">Instance of AutoNumber</param>
			set
			{
				 this.autoNumber61=value;
