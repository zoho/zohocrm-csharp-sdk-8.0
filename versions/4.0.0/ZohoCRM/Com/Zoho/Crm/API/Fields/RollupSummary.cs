...
namespace Com.Zoho.Crm.API.Fields
{
	...
	public class RollupSummary : Model
	{
		...
		private Modules.MinifiedModule basedOnModule;
		private RelatedLists.RelatedList relatedList;
		...
		public Modules.MinifiedModule BasedOnModule
		{
			...
			/// <param name="basedOnModule">Instance of MinifiedModule</param>
			set
			{
		...
		public RelatedLists.RelatedList RelatedList
		{
