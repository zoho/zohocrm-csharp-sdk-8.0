...
namespace Samples.CustomViews
{
    ...
    {
        public static void GetCustomViews_1()
        {
            CustomViewsOperations customViewsOperations = new CustomViewsOperations();
            ParameterMap paramInstance = new ParameterMap();
            paramInstance.Add(CustomViewsOperations.GetCustomViewsParam.MODULE, "Leads");
            paramInstance.Add(CustomViewsOperations.GetCustomViewsParam.PAGE, 1);
            paramInstance.Add(CustomViewsOperations.GetCustomViewsParam.PER_PAGE, 20);
