...
using static Com.Zoho.Crm.API.Notifications.NotificationsOperations;

namespace Samples.Notifications_1
{
    public class DisableNotifications
    {
        public static void DisableNotifications_1()
        {
            try
            {
                ...
                paramInstance.Add(DeleteNotificationParam.CHANNEL_IDS, string.Join(",", channelIds));

                APIResponse<ActionHandler> response = notificationsOperations.DeleteNotification(paramInstance);
