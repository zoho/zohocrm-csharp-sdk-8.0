...
{
    public class EnableBaseCurrency
    {
        public static void EnableBaseCurrency_1()
        {
            ...
            baseCurrency.Name = "Algerian Dinar - DZD";
            baseCurrency.IsoCode = "DZD";
            baseCurrency.Symbol = "DA";
            baseCurrency.ExchangeRate = "2.0";
            ...
            APIResponse<ActionHandler> response = currenciesOperations.EnableBaseCurrency(baseCurrencyWrapper);
