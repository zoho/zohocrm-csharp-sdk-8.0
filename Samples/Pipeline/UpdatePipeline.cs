...
namespace Samples.Pipeline
{
    ...
    {
        public static void UpdatePipeline_1(long pipelineId)
        {
            try
            {
                ...
                pipeline.DisplayValue = "Updated Single Pipeline";
                pipeline.ActualValue = "updated_single_pipeline";
