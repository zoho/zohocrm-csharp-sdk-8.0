...
namespace Samples.Attachments
{
    ...
    {
        public static void DeleteAttachments_1(string moduleAPIName, long recordId, List<long> attachmentIds)
        {
        ...
        public static void Call()
        {
            try
            {
                ...
                List<long> attachmentIds = new List<long>() { 440248001286011l, 440248001286012l };
