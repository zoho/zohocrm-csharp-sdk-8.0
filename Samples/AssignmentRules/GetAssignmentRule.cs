...
using GetAssignmentRuleParam = Com.Zoho.Crm.API.AssignmentRules.AssignmentRulesOperations.GetAssignmentRuleParam;
...
namespace Samples.AssignmentRules
{
    ...
    {
        public static void GetAssignmentRule_1(long assignmentRuleId)
        {
            ...
            APIResponse<ResponseHandler> response = assignmentRulesOperations.GetAssignmentRule(assignmentRuleId, paramInstance);
            if (response != null)
            {
        ...
        public static void Call()
        {
            try
            {
                ...
                long assignmentRuleId = 34770621194003L;
                GetAssignmentRule_1(assignmentRuleId);
            }
            catch (Exception e)
            {
