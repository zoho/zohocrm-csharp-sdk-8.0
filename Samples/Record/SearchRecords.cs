    ...
    public class SearchRecords
    {
        public static void SearchRecords_1(string moduleAPIName)
        {
            try
            {
                ...
                //paramInstance.Add(RecordOperations.SearchRecordsParam.CRITERIA, "(Lead_Source:equals:Web Form)");
                //paramInstance.Add(RecordOperations.SearchRecordsParam.EMAIL, "sample@example.com");
                paramInstance.Add(RecordOperations.SearchRecordsParam.PHONE, "9876543210");
                //paramInstance.Add(RecordOperations.SearchRecordsParam.WORD, "Test");
                paramInstance.Add(RecordOperations.SearchRecordsParam.PAGE, 1);
                paramInstance.Add(RecordOperations.SearchRecordsParam.PER_PAGE, 5);
                //paramInstance.Add(RecordOperations.SearchRecordsParam.FIELDS, "First_Name,Last_Name,Email,Phone");
                HeaderMap headerInstance = new HeaderMap();
                APIResponse<ResponseHandler> response = recordOperations.SearchRecords(paramInstance, headerInstance);
