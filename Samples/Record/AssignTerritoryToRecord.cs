...
namespace Samples.Record
{
    ...
    {
        /// <summary>
        /// This method is used to assign territory to a single record
        /// </summary>
        /// <param name="moduleAPIName">The API name of the module</param>
        /// <param name="recordId">The ID of the record</param>
        public static void AssignTerritoryToRecord_1(string moduleAPIName, long recordId)
        {
            try
            {
                ...
                // Call AssignTerritoryToRecord method that takes recordId and BodyWrapper instance as parameter
                APIResponse<ActionHandler> response = recordOperations.AssignTerritoryToRecord(recordId, bodyWrapper);
        ...
        public static void Call()
        {
            try
            {
                ...
                AssignTerritoryToRecord_1("Leads", 4834857410003040001L);
            }
            catch (Exception ex)
            {
