...
namespace Samples.RelatedRecords
{
    ...
    {
        public static void GetRelatedRecordUsingExternalId_1(string moduleAPIName, string externalValue, string relatedListAPIName, string externalFieldValue)
        {
            try
            {
                ...
                paramInstance.Add(GetRelatedRecordUsingExternalIDParam.FIELDS, "Last_Name,First_Name,Email,Phone,Created_Time,Modified_Time,Owner");

                HeaderMap headerInstance = new HeaderMap();
                headerInstance.Add(GetRelatedRecordUsingExternalIDHeader.X_EXTERNAL, "Leads.External,Products.Products_External");
        ...
        public static void Call()
        {
            try
            {
                ...
                GetRelatedRecordUsingExternalId_1(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue);
            }
            catch (Exception e)
            {
                Console.WriteLine(JsonConvert.SerializeObject(e));
