...
namespace Samples.EmailTemplates
{
    ...
    {
        public static void GetEmailTemplates_1()
        {
            EmailTemplatesOperations emailTemplatesOperations = new EmailTemplatesOperations();
            ParameterMap paramInstance = new ParameterMap();

            // Add parameters if needed
            // paramInstance.Add(EmailTemplatesOperations.GetEmailTemplatesParam.MODULE, "Leads");
            // paramInstance.Add(EmailTemplatesOperations.GetEmailTemplatesParam.CATEGORY, "created_by_admin");
            ...
            if (response != null)
            {
                ...
                if (response.IsExpected)
                {
                    ...
                    if (responseHandler is ResponseWrapper)
                    {
                        ...
                        if (info != null)
                        {
                            Console.WriteLine("EmailTemplates Info:");
