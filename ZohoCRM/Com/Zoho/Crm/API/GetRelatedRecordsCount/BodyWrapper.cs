...
namespace Com.Zoho.Crm.API.GetRelatedRecordsCount
{
	...
	{
		private List<GetRelatedRecordCount> getRelatedRecordsCount;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<GetRelatedRecordCount> RelatedRecordsCount
		{
			/// <summary>The method to get the getRelatedRecordsCount</summary>
			/// <returns>Instance of List<GetRelatedRecordCount></returns>
			get
			{
			...
			/// <param name="getRelatedRecordsCount">Instance of List<GetRelatedRecordCount></param>
			set
			{
