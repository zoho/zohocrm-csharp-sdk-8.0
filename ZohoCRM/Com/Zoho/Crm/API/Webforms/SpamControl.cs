...
namespace Com.Zoho.Crm.API.Webforms
{
	...
	public class SpamControl : Model
	{
		private string status;
		private string excludeScore;
		private int? spamPossibilityThreshold;
		...
		public int? SpamPossibilityThreshold
		{
			/// <summary>The method to get the spamPossibilityThreshold</summary>
			/// <returns>int? representing the spamPossibilityThreshold</returns>
			get
			{
				return  this.spamPossibilityThreshold;

			}
			/// <summary>The method to set the value to spamPossibilityThreshold</summary>
			/// <param name="spamPossibilityThreshold">int?</param>
			set
			{
				 this.spamPossibilityThreshold=value;
